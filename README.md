...
Check out the sample gradle test report that's been added to this repo in the [/example-report](/example-report/index.html) package. The report has a handful of sample failures in it that demo the experience.
